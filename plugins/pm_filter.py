...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [   
	    InlineKeyboardButton(text="♀️ 𝗛𝗢𝗪 𝗧𝗢 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 ♀️", url='https://t.me/TG_UPDATES1/342')
        ]   
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            return await query.answer('♥️ Love @KUSHALHK ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/TG_LINKS_CHANNEL"),
            InlineKeyboardButton('🔔 UPDATES 🤖', url='https://t.me/TG_UPDATES1')
            ],[
